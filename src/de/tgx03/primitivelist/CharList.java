...
/**
 * A list using primitive chars instead of object ones
 */
public class CharList {
     ...
     */
    public CharList(int length) {
        arr = new char[length];
    }

    /**
     * Creates a new list from a given char array
     * @param list The array this holds initially
     */
    public CharList(char[] list) {
     ...
     */
    public void set(char value, int position) {
